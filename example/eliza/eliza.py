...
#source: https://github.com/dhconnelly/paip-python/blob/master/paip/eliza.py
...
def is_variable(pattern):
    ...
    return (type(pattern) is str
            ...
            and len(pattern) > 1
            and pattern[1] != '*'
            and pattern[1] in string.ascii_uppercase
            and ' ' not in pattern)
...
def is_segment(pattern):
    ...
    return (type(pattern) is list
            ...
            and pattern[0][0] == '?'
            and pattern[0][1] == '*'
            and pattern[0][2] in string.ascii_uppercase
